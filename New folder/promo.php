...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div><a href="tambah.php" class="fa fa-plus pull-right" style="margin-right:10px;font-size:15px"> Tambah</a>  </div><br><br>
            </div>
            <?php 
                $query = mysql_query("select nama,keterangan from promo where status='1'");
                $no=1;
                while ($dat=mysql_fetch_array($query)){?>
                    
                    <div class="row">
                        <div class="panel panel-default" style="margin-left:20px">
                            <div class="panel-heading"><?php echo $dat['nama']; ?></div>
